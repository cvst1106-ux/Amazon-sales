...
Amazon es una multinacional tecnológica estadounidense que ha
evolucionado rápidamente desde su creación en 1994. A pesar de su éxito
comercial, su amplitud y variedad en el mercado presenta dificultades
para los vendedores y compradores. Esta investigación pretende aclarar
las dudas relacionadas a los precios, porcentajes de descuento y
diferencias de estos entre categorías
...
en todo el mundo y Amazon music (2011).\\
...
producto (Id del producto), el nombre asignado del objeto que se está
vendiendo (nombre del producto), clasificación del producto (categoría),
costo del producto después de aplicar la rebaja (precio con descuento),
costo del producto sin ningún descuento (precio actual) y el porcentaje
de rebaja aplicado (porcentaje de descuento).
...
La cobertura vertical está comprendida por 1465 registros, que
corresponden a productos comercializados en Amazon, cada fila representa
un producto con un ID único con sus características, precio, porcentaje
de descuento y precio con el descuento.
